...
1) Використовується модуль json для роботи з форматом збереження даних та модуль os для взаємодії з файловою системою, зокрема для перевірки наявності існуючого файлу.  
